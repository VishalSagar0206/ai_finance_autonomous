import pytest
from adk_framework_v3.core.state import ADKState, UserRequest, ApprovalStatus, DraftStrategy

def test_state_initialization():
    """Verify ADKState initializes correctly with mandatory fields."""
    request = UserRequest(asset_class="Equities", risk_tolerance="Low", time_horizon="5y", tickers=["AAPL"])
