...
class VisionSignal(BaseModel):
    ...
    object_counts: Dict[str, int] = Field(description="Count of detected objects (e.g., cars, tankers).")
...
class AlternativeDataClient:
    ...
    @staticmethod
    def analyze_image_signal(image_url: str, prompt_context: str) -> Optional[VisionSignal]:
        """
